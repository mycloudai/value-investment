...
summary: "可转换证券（可转债、可转换优先股）是巴菲特在特定情况下使用的投资工具。兼具债券的安全性和股票的上行潜力。伯克希尔在所罗门兄弟、美国运通、高盛、通用电气等危机时期的救援投资中大量使用可转换优先股，既获保护又分享上行收益。"
category: "concept"
slug: "convertible-securities"
tags:
  - "可转换证券"
  - "优先股"
  - "固定收益"
...
description: "巴菲特多次通过可转换优先股投资大公司，兼具下行保护和上行参与的特点。"
...
**1987-1991年的五大可转换优先股投资**是巴菲特运用此工具的经典案例：
...
**2008年金融危机中的投资**是另一高峰。巴菲特在箭牌、高盛和通用电气发行的固定收益证券上总共投入了145亿美元。这些投资都附带可观的股权参与（认股权证），既有很高的当期收益率，又保留了上行空间。其中高盛的优先股年息10%，附带以每股115美元行使的认股权证，后来为伯克希尔带来了数十亿美元的利润。

**1976-1977年的盖可保险可转换优先股**是早期案例。当时盖可保险濒临破产，巴菲特通过购买其可转换优先股进行了一笔典型的逆向投资，这笔投资后来成为伯克希尔历史上回报最高的投资之一。

**1989年伯克希尔自身发行的零息可转换债券**则展示了硬币的另一面。巴菲特以发行人的身份发行了本金9.026亿美元的零息可转换次级债券，实际融资成本远低于5.5%。这说明他不仅会买入可转换证券，也懂得利用市场对这类工具的需求来低成本融资。
...
1991年：购入第一帝国银行可转换优先股（4,000万美元）和美国运通 Percs（3亿美元），可转换投资达到高峰
